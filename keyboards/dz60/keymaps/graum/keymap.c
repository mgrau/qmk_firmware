...
#define DEL_ALT MT(KC_LALT, KC_DEL)
...
#define MGLAYOUT( \
    ...
    k40, k41,      k43,           k46,                     k4b,      k4d, kde  \
) { \
    { k00,  k01,   k02,   k03,  k04,  k05,   k06,  k07,   k08,  k09,   k0a,  k0b,  k0c,   KC_NO, k0e   }, \
    { k10,  KC_NO, k12,   k13,  k14,  k15,   k16,  k17,   k18,  k19,   k1a,  k1b,  k1c,   k1d,   k1e   }, \
    { k20,  KC_NO, k22,   k23,  k24,  k25,   k26,  k27,   k28,  k29,   k2a,  k2b,  k2c,   k2d,   KC_NO }, \
    { k30,  KC_NO, k32,   k33,  k34,  k35,   k36,  k37,   k38,  k39,   k3a,  k3b,  KC_NO, k3d,   k3e   }, \
    { k40,  k41,   KC_NO, k43,  KC_NO,KC_NO, k46,  KC_NO, KC_NO,KC_NO, KC_NO,k4b,  KC_NO, k4d,   kde   }  \
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_RGHT,\
    DEL_CTL, KC_LGUI, DEL_ALT,                            SPACE_MOD,                                            LFT_CAD, MO(FUN), RGT_CTL \
    ),
	[SPACE] = MGLAYOUT(
    ...
    _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, MO(CAD),\
    ...
    KC_ESC,  KC_LGUI, KC_LALT,                            KC_SPC,                                               KC_RALT, _______, KC_RCTL \
    ),
    [CAD] = MGLAYOUT(
    ...
    _______,          X(LDO),  X(LUP),  X(NOTE), X(ASYM), X(EQIV), X(LEQ),  X(GEQ),  _______, _______, _______,          _______, _______,\
    ...
    MO(UP),           X(F_z),  X(F_x),  X(F_c),  X(F_v),  X(F_b),  X(F_n),  X(F_m),  X(F_ll), X(F_gg), X(Fint),          MO(UP),  _______,\
    _______, _______, _______,                            _______,                                              _______, _______, _______ \
    ),
    [UP] = MGLAYOUT(
