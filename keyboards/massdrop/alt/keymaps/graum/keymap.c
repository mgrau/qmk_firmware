...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            LT(_SL, KC_SPC),                             KC_RALT, MO(_FL), KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [_SL] = LAYOUT(
        CTL_GRV, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, KC_MRWD, KC_MPLY, KC_MFFD, _______, _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  _______, _______, _______, _______, _______, \
    ...
    [_FL] = LAYOUT(
        ...
        L_T_PTD, L_PTP,   L_BRD,   L_PTN,   _______, TG(_GL), _______, _______, _______, _______, _______, _______,          _______, KC_VOLU, \
