...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT(
         KC_ESC,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,            KC_PSCR, TG(_GL), KC_PAUS,
        ...
        KC_LCTL, KC_LGUI, KC_LALT,           LT(_SL, KC_SPC),                            KC_RALT, MO(_FL),  KC_APP, KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FL] = LAYOUT(
        ...
        _______,  L_T_MD, L_T_ONF, _______, _______, _______, _______, _______, _______, _______, _______, _______,                              _______,
    ...
    [_SL] = LAYOUT(
        ...
        _______, KC_MRWD, KC_MPLY, KC_MFFD, _______, _______, _______, KC_HOME, KC_PGUP, KC_PGDN,  KC_END, _______, _______, _______,   _______, _______, _______,
